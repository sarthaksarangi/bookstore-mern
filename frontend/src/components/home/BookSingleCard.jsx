...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <div className=' rounded-xl px-4 py-2 m-4 relative shadow-lg  ease-in-out duration-150 '>
      <h2 className='absolute top-3 right-3  px-4 py-1 bg-emerald-400 text-white rounded-lg'>
        {book.publishYear}
      </h2>
